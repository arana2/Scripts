...
try {
	## First attempt to create a username with first initial and last name e.g., jsmith
	...
	if ($userName -like "$FirstName*") {
		...
		## Create a random password - minimum length of 10 and max of 12
		Add-Type -AssemblyName 'System.Web'
		$password = [System.Web.Security.Membership]::GeneratePassword((Get-Random -Minimum 10 -Maximum 12), 3)
